    ...
    <div className="flex flex-col h-full" style={{ background: 'var(--bg-base)' }}>
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="flex flex-col flex-1 overflow-hidden">
          <div className="border-b p-3 flex-shrink-0" style={{ borderColor: 'var(--border)' }}>
          ...
          <div className="flex-1 overflow-auto p-3">
            <div className="text-xs font-semibold tracking-wider mb-2" style={{ color: 'var(--text-secondary)' }}>
              OPEN POSITIONS
            </div>
            <PositionTable />
          </div>
        ...
        <div className="w-72 flex-shrink-0 border-l flex flex-col"
          ...
          <div className="p-3 border-b" style={{ borderColor: 'var(--border)' }}>
            <div className="text-xs font-semibold tracking-wider mb-3" style={{ color: 'var(--text-secondary)' }}>
              SENTIMENT RADAR
            </div>
      ...
      <footer className="px-4 py-1.5 border-t flex items-center justify-between text-xs flex-shrink-0"
        style={{ borderColor: 'var(--border)', background: 'var(--bg-surface)', color: 'var(--text-muted)' }}>
        <span>New Vantage Co © 2026</span>
        <span className="font-mono">claude-opus-4-6 · FinBERT · OANDA</span>
